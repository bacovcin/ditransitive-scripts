...
parameters {
  ...
  real<lower=0,upper=10> b1[6];
  real<lower=0,upper=10> b2[6];
...
model {
  ...
  b1[2] ~ normal(bMu1[2], bSigma1[2]) T[0,10];
  b1[3] ~ normal(bMu1[3], bSigma1[3]) T[0,10];
  b1[4] ~ normal(bMu1[4], bSigma1[4]) T[0,10];
  b1[5] ~ normal(bMu1[5], bSigma1[5]) T[0,10];
  b1[6] ~ normal(bMu1[6], bSigma1[6]) T[0,10];

  b2[1] ~ normal(bMu2[1], bSigma2[1]) T[0,10];
  b2[2] ~ normal(bMu2[2], bSigma2[2]) T[0,10];
  b2[3] ~ normal(bMu2[3], bSigma2[3]) T[0,10];
  b2[4] ~ normal(bMu2[4], bSigma2[4]) T[0,10];
  b2[5] ~ normal(bMu2[5], bSigma2[5]) T[0,10];
  b2[6] ~ normal(bMu2[6], bSigma2[6]) T[0,10];
