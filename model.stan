...
parameters {
  real<lower=-5,upper=5> a[4,6];
  real<lower=0,upper=10> b[4,6];
  ...
  for (i in 1:4) {
    for (n in 1:N) {
      if (cond[n] == 1) {
        ...
        mu[i,n] <- (1 / (1 + exp(-(a[i,2] + b[i,2] * x[n]))))*(1-(heavy[i] / (1 + exp(-(a[i,3] + b[i,3] * x[n])))));
      }
      else if (cond[n] == 3) {
        mu[i,n] <- (1 / (1 + exp(-(a[i,4] + b[i,4] * x[n]))));
      }
      else if (cond[n] == 4) {
        mu[i,n] <- (1 / (1 + exp(-(a[i,5] + b[i,5] * x[n]))));
      }
      else if (cond[n] == 5) {
        mu[i,n] <- (1 / (1 + exp(-(a[i,6] + b[i,6] * x[n]))));
      }
...
model {
  ...
  a[1,6] ~ normal(aMu[6], aSigma[6]) T[-5,5];
  ...
  a[2,6] ~ normal(aMu[6], aSigma[6]) T[-5,5];
  ...
  a[3,6] ~ normal(aMu[6], aSigma[6]) T[-5,5];
  ...
  a[4,6] ~ normal(aMu[6], aSigma[6]) T[-5,5];
  ...
  b[1,6] ~ normal(bMu[6], bSigma[6]) T[0,10];

  b[2,1] ~ normal(bMu[1], bSigma[1]) T[0,10];
  b[2,2] ~ normal(bMu[1], bSigma[1]) T[0,10];
  b[2,3] ~ normal(bMu[3], bSigma[3]) T[0,10];
  b[2,4] ~ normal(bMu[4], bSigma[4]) T[0,10];
  b[2,5] ~ normal(bMu[5], bSigma[5]) T[0,10];
  b[2,6] ~ normal(bMu[6], bSigma[6]) T[0,10];

  b[3,1] ~ normal(bMu[1], bSigma[1]) T[0,10];
  b[3,2] ~ normal(bMu[2], bSigma[2]) T[0,10];
  b[3,3] ~ normal(bMu[4], bSigma[4]) T[0,10];
  b[3,4] ~ normal(bMu[4], bSigma[4]) T[0,10];
  b[3,5] ~ normal(bMu[5], bSigma[5]) T[0,10];
  b[3,6] ~ normal(bMu[6], bSigma[6]) T[0,10];

  b[4,1] ~ normal(bMu[1], bSigma[1]) T[0,10];
  b[4,2] ~ normal(bMu[1], bSigma[1]) T[0,10];
  b[4,3] ~ normal(bMu[4], bSigma[4]) T[0,10];
  b[4,4] ~ normal(bMu[4], bSigma[4]) T[0,10];
  b[4,5] ~ normal(bMu[5], bSigma[5]) T[0,10];
  b[4,6] ~ normal(bMu[6], bSigma[6]) T[0,10];
